...
from src.commercial_dashboard_plus import render_commercial_dashboard_plus
...
app_shell.FUNCTIONAL_MODULES["Panel comercial"] = render_commercial_dashboard_plus
run_app()
