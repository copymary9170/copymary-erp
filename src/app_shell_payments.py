...
from src.commercial_reports_plus import render_commercial_reports_plus
...
app_shell.FUNCTIONAL_MODULES['Reportes comerciales'] = render_commercial_reports_plus
