...
PROFILES: tuple[EquipmentProfile, ...] = (
    EquipmentProfile(
        ...
        equipment="Impresora de tanque de tinta / tinta continua",
        role="Impresión de documentos, stickers, fotografías y papelería personalizada con sistemas de tanque recargable.",
        typical_jobs=("Documentos", "stickers", "fotografías", "tarjetas", "papelería personalizada"),
        wear_parts=("Cabezal o cabezales según modelo", "depósito/almohadilla/caja de mantenimiento según modelo", "rodillos", "tintas"),
        usage_metric="Páginas impresas",
        maintenance_focus=("test de inyectores", "limpieza solo cuando sea necesaria", "control de rodillos y alimentación", "seguir el procedimiento específico del fabricante para cabezales y mantenimiento"),
        electrical_level="Baja",
        voltage_note="La alimentación y el consumo cambian por marca y modelo; verificar siempre la placa/manual del equipo concreto.",
        watts_reference=12.0,
        amps_reference=0.4,
        electrical_notes=("Familia tecnológica genérica: incluye HP Smart Tank, Epson EcoTank, Canon PIXMA G/MegaTank y Brother InkBenefit Tank.", "La referencia eléctrica mostrada abajo corresponde solo al modelo Epson citado y no debe aplicarse automáticamente a HP, Canon o Brother.", "No necesita tratarse como una carga térmica grande."),
        environment_notes=("Evitar calor directo, humedad condensante y polvo de papel.",),
        source_label="Referencia de ejemplo — Epson ET-2800: 100–240 V, 0.4–0.2 A, aprox. 12 W copiando. Verificar la ficha del modelo real.",
