"""Renderer unificado de Marketing Pro + plan + contenido + video + UGC/TikTok + mercado/Ads + Skills + IA."""
...
from src.marketing_ai_skills import render_marketing_ai_skills
from src.marketing_ai_builder import render_marketing_ai_builder


def render_marketing() -> None:
    """Marketing Pro completo: estrategia, investigación, producción, experimentación, paid media, Skills e IA."""
