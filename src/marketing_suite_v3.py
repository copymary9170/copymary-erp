"""Renderer unificado de Marketing Pro + plan guiado + contenido + storytelling/video + IA."""
...
def render_marketing() -> None:
    """Conserva Marketing Pro y agrega metodología guiada, investigación, storytelling/video y AI Builder."""
