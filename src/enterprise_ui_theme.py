...
def apply_enterprise_theme() -> None:
    st.markdown(
        ...
        div[data-testid="stRadio"]>div{display:flex!important;flex-wrap:nowrap!important;overflow-x:auto!important;overflow-y:hidden!important;gap:.32rem!important;padding:.08rem 0 .35rem;scrollbar-width:thin;scrollbar-color:rgba(109,74,255,.28) transparent}
        div[data-testid="stRadio"]>div::-webkit-scrollbar{height:5px}div[data-testid="stRadio"]>div::-webkit-scrollbar-thumb{background:rgba(109,74,255,.28);border-radius:999px}
