...
def next_control_number(last_number: str | None, prefix: str = "00-") -> str:
    ...
    # Solo se cuenta la secuencia POSTERIOR al prefijo: si el prefijo contiene
    # dígitos (p. ej. "00-"), incluirlos inflaba el ancho y producía un número
    # más largo del debido ("00-0000000010" en vez de "00-00000010").
